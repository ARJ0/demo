...
.ar_main_div_<?php echo $form_id; ?> .arf_materialize_form input[type=tel],
.ar_main_div_<?php echo $form_id; ?> .arf_materialize_form select,
.ar_main_div_<?php echo $form_id; ?> .arf_materialize_form textarea:not(.html_field_description):not(.g-recaptcha-response),
...
.ar_main_div_<?php echo $form_id; ?> .arf_materialize_form .controls .picker-switch td span.glyphicon-time,
.ar_main_div_<?php echo $form_id; ?> .arf_materialize_form .controls .picker-switch td span.glyphicon-calendar{
    background-color:<?php echo $base_color; ?>;
}

.ar_main_div_<?php echo $form_id; ?> .arf_materialize_form .controls .picker-switch td span.glyphicon-time:hover,
.ar_main_div_<?php echo $form_id; ?> .arf_materialize_form .controls .picker-switch td span.glyphicon-calendar:hover{
...
.ar_main_div_<?php echo $form_id;?> .arf_materialize_form .controls .timepicker .glyphicon-chevron-down::before,
.ar_main_div_<?php echo $form_id;?> .arf_materialize_form .controls .timepicker .glyphicon-chevron-up::before,
...
.ar_main_div_<?php echo $form_id;?> .arf_materialize_form .controls .timepicker .glyphicon-chevron-down:hover,
.ar_main_div_<?php echo $form_id;?> .arf_materialize_form .controls .timepicker .glyphicon-chevron-up:hover,
...
.ar_main_div_<?php echo $form_id;?> .arf_materialize_form .controls .glyphicon-time:before,
.ar_main_div_<?php echo $form_id;?> .arf_materialize_form .controls .glyphicon-calendar:before{
    color: <?php echo($arsettingcontroller->isColorDark($base_color) == '1')?'#ffffff':'#1A1A1A'?>;
}
