...
if (!function_exists('arf_display_form_preview')) {
    ...
    function arf_display_form_preview($form_id, $form_key, $posted_data = array()) {
        ...
        if (!isset($posted_data) || empty($posted_data)) {
            $arf_form .= addslashes(__('Please select valid form', 'ARForms'));
            echo $arf_form;
            die();
        }
        ...
        if( $posted_data['arfinpst'] == 'material' ){
        ...
        if ($values['fields'] and $page_num > 0) {
            ...
            if ($field_page_break_type == 'survey') {
                ...
                if($field_page_break_top_bar != 1) {
                    $arf_form .= '<div class="arf_survey_nav"><div id="current_survey_page" class="survey_step">' . __('Step', 'ARForms') . ' </div><div id="current_survey_page" class="current_survey_page">1</div><div class="survey_middle">' . __('of', 'ARForms') . '</div><div id="total_survey_page" class="total_survey_page">' . ($total_page_shows + 1) . '</div></div>';
