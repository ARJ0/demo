...
== Description ==
CorpoBell is a multi-purpose WordPress theme with practically unlimited options for customization, making it an excellent choice for any business. It can be used to create any type of website like consultancy, finance, corporate, travel, education, medical. It is responsive, SEO friendly, speed optimized, and translation ready. CorpoBell is retina ready and fully responsive. CorpoBell theme has wide list of customizable features including front page customizable sections with customizer api and many more options. This theme comes with lots of features such as column layout options for front page sections.
...
CorpoBell WordPress Theme, Copyright 2020 Sensational Theme
CorpoBell is distributed under the terms of the GNU General Public License v2
Link: http://www.sensationaltheme.com/downloads/corpobell-free/
...
Screenshot Image
License: CC0 1.0 Universal (CC0 1.0)
https://pxhere.com/en/photo/1223786
...
= 1.0.3 - January 7, 2021 =
* Updated Sidebar issues

= 1.0.2 - January 6, 2021 =
* Updated Blog design issue
