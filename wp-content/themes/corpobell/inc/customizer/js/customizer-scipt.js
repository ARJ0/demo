...
( function( $, api ) {
	...
	api.controlConstructor['corpobell-repeater-text'] = api.Control.extend({
	    ...
	    // upsell 
    api.sectionConstructor['corpobell-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#corpobell-img-container li label img').click(function(){    	
    //     $('#corpobell-img-container li').each(function(){
    //         $(this).find('img').removeClass ('corpobell-radio-img-selected') ;
    //     });
    //     $(this).addClass ('corpobell-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', corpobell_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', corpobell_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', corpobell_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #corpobell-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #corpobell-img-container li').each(function(){
            $(this).find('img').removeClass ('corpobell-radio-img-selected') ;
        });
        $(this).addClass ('corpobell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #corpobell-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #corpobell-img-container li').each(function(){
            $(this).find('img').removeClass ('corpobell-radio-img-selected') ;
        });
        $(this).addClass ('corpobell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #corpobell-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #corpobell-img-container li').each(function(){
            $(this).find('img').removeClass ('corpobell-radio-img-selected') ;
        });
        $(this).addClass ('corpobell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #corpobell-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #corpobell-img-container li').each(function(){
            $(this).find('img').removeClass ('corpobell-radio-img-selected') ;
        });
        $(this).addClass ('corpobell-radio-img-selected') ;
    });    

    function corpobell_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            corpobell_customize_multi_write( $control );
    }

    function corpobell_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        corpobell_customize_multi_write( $control );
    }

    function corpobell_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function corpobell_customize_multi_write( $element) {
