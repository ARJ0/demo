...
class CorpoBell_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="corpobell-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class CorpoBell_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class CorpoBell_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class CorpoBell_Note_Control extends WP_Customize_Control {
