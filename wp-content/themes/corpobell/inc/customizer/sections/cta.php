...
$wp_customize->add_section( 'section_cta',
	array(
		'title'      => __( 'Call To Action Section', 'corpobell' ),
		'priority'   => 25,
...
$wp_customize->add_control( new CorpoBell_Switch_Control( $wp_customize, 'theme_options[disable_cta_section]',
    array(
		'label' 			=> __('Disable Call to action section', 'corpobell'),
		'section'    		=> 'section_cta',
...
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize,
	...
	'active_callback' => 'corpobell_cta_active',
	'type'        => 'image',
	)
	)
);
...
$wp_customize->add_control('theme_options[cta_page]', 
	array(
	'label'       => __('Select Page', 'corpobell'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_button_label]', 
	array(
	'label'       => __('Button Label', 'corpobell'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_alt_button_label]', 
	array(
	'label'       => __('Alt Button Label', 'corpobell'),
	'section'     => 'section_cta',   
