...
$wp_customize->add_section( 'section_featured_slider',
	array(
		'title'      => __( 'Featured Slider Section', 'corpobell' ),
		'priority'   => 10,
...
$wp_customize->add_control( new CorpoBell_Switch_Control( $wp_customize, 'theme_options[disable_featured-slider_section]',
    array(
		'label' 	=> __('Disable slider Section', 'corpobell'),
...
$wp_customize->add_setting('theme_options[slider_speed]', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',	
	'sanitize_callback' => 'corpobell_sanitize_number_range'
	)
);

$wp_customize->add_control('theme_options[slider_speed]', 
	array(
	'label'       => __('Slider Speed', 'corpobell'),
	'description' => __('Slider Speed Default speed 800', 'corpobell'),
	'section'     => 'section_featured_slider',   
	'settings'    => 'theme_options[slider_speed]',		
	'type'        => 'number',
	'active_callback' => 'corpobell_slider_active',
	)
);
...
for( $i=1; $i<=3; $i++ ){
	...
	$wp_customize->add_control('theme_options[slider_custom_btn_text_' . $i . ']', 
		array(
		'label'       => sprintf( __('Button Label %d', 'corpobell'),$i ),
		'section'     => 'section_featured_slider',   
	...
	$wp_customize->add_control( new CorpoBell_Customize_Horizontal_Line( $wp_customize, 'theme_options[slider_hr_'. $i .']',
		array(
			'section'         => 'section_featured_slider',
			'active_callback' => 'corpobell_slider_active',
			'type'			  => 'hr',
...
$wp_customize->add_control('theme_options[slider_alt_custom_btn_text]', 
	array(
	'label'       => __('Alternative Button Label', 'corpobell'),
	'section'     => 'section_featured_slider',   
...
$wp_customize->add_control('theme_options[slider_alt_custom_btn_url]', 
	array(
	'label'       => __('Alternative Button Url', 'corpobell'),
	'section'     => 'section_featured_slider',   
