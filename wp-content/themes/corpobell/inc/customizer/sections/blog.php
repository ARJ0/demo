...
$wp_customize->add_section( 'section_home_blog',
	array(
		'title'      => __( 'Blog Section', 'corpobell' ),
		'priority'   => 110,
...
$wp_customize->add_control( new CorpoBell_Switch_Control( $wp_customize, 'theme_options[disable_blog_section]',
    array(
		'label' 	=> __('Disable Blog Section', 'corpobell'),
...
$wp_customize->add_control('theme_options[blog_title]', 
	...
	'active_callback' => 'corpobell_blog_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control(
	new CorpoBell_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
