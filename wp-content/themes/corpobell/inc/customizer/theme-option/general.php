...
'title'       => __('General Setting', 'corpobell'),
...
$wp_customize->add_control( new CorpoBell_Switch_Control( $wp_customize, 'theme_options[disable_homepage_content_section]',
    array(
		'label' 			=> __('Enable/Disable Static Homepage Content Section', 'corpobell'),
		'description' => __('This option is only work on Static HomePage ', 'corpobell'),
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'corpobell_sanitize_positive_integer',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => esc_html__( 'Excerpt Length', 'corpobell' ),
	'description' => esc_html__( 'in words', 'corpobell' ),
	'section'     => 'section_general',
	'type'        => 'number',
